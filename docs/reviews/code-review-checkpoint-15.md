...
|---|----------|-------|--------|
| 1 | Suggestion | Note that `up`'s backend-missing *message* intentionally changed (happy path stays byte-identical) | docs/backlog |
